...
{
    /// <summary>
    /// Helper for accessing CosmosDB. 
    //Set the endpoint URI and Access Key (find these in the portal), 
    //your DB and Collection names, and then build your instance.
    /// </summary>
    public class CosmosDBHelper
    {
        ...
        public static async Task<CosmosDBHelper> BuildAsync()
        {
            ...
            var db = (await client.CreateDatabaseIfNotExistsAsync(
                new Database() { Id = DatabaseName })).Resource;
